...
class Model(nn.Module):
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        self.patch_embedding = PatchEmbeddingTimeLLM(
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, prompt_class, x_charge_data, x_discharge_data, RPT_masks, mask=None):
        if self.task_name == 'long_term_forecast' or self.task_name == 'short_term_forecast':
