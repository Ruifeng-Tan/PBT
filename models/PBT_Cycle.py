...
class Model(nn.Module):
    ...
    def __init__(self, battery_life_config):
        ...
        self.cycle_embedding = nn.Embedding(self.early_cycle_threshold, self.d_llm)
    ...
    def forward(self, cycle_curve_data, curve_attn_mask, 
        ...
        cycle_index = torch.sum(curve_attn_mask, dim=1).int() - 1
        cycle_info = self.cycle_embedding(cycle_index)
        DKP_embeddings = DKP_embeddings + cycle_info
