...
class Model(nn.Module):
    ...
    def __init__(self, battery_life_config):
        ...
        self.gate = PatternRouterMLP(self.d_llm, self.num_experts*self.moe_layers + configs.cathode_experts*2)
    ...
    def forward(self, cycle_curve_data, curve_attn_mask, 
        ...
        total_guide_loss = 0
        total_aug_count = 0
        out, _, guide_loss = self.flattenIntraCycleLayer(cycle_curve_data, intra_cathode_logits, cathode_masks) # [B, L, d_model]
        ...
        out, _, guide_loss = self.flattenInterCycleLayer(out, inter_cathode_logits, cathode_masks)
        total_guide_loss += guide_loss
        # logits_index += 1
        # total_aug_loss += aug_loss
        # total_aug_count += 1
        ...
        return preds, None, llm_out, feature_llm_out, None, None, total_aug_loss / total_aug_count, total_guide_loss / 2
