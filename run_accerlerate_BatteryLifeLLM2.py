...
from models import BatteryMoE_PTv2, \
            BatteryMoE_DG, BatteryMoE_DG_MLPGate, BatteryMoE_PT, BatteryMoE_Seek_Connect
import wandb
...
for ii in range(args.itr):
    ...
    setting = '{}_sl{}_lr{}_dm{}_nh{}_el{}_dl{}_df{}_llmLayers{}_Lora{}_lradj{}_dataset{}_cl{}_DG{}_loss{}_wd{}_wl{}_pretrained{}_rnnL{}_dr{}_IW{}_NumE{}_K{}'.format(
        args.model,
        args.seq_len,
        args.learning_rate,
        args.d_model,
    ...
    elif args.model == 'BatteryMoE_Seek_Connect':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_Seek_Connect.Model(model_config)
