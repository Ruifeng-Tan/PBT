...
from models import BatteryMoE_Gating_ImpGate, BatteryMoE_Gating_cl, BatteryMoE_baseline, BatteryMoE_baseline_Gating, BatteryMoE_v1_casual, BatteryMoE_Gating_dVdQ_multi, BatteryMoE_Gating
import wandb
...
for ii in range(args.itr):
    ...
    elif args.model == 'BatteryMoE_Gating_cl':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_Gating_cl.Model(model_config)
    ...
    elif args.model == 'BatteryMoE_v1_casual':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_v1_casual.Model(model_config)
