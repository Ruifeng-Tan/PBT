...
parser.add_argument('--model', type=str, required=False, default='Autoformer',
                    help='model name, including PBT, CPTransformerDeepSeekMoE, CPMLP, CPTransformer, and BatLiNet')
...
for ii in range(args.itr):
    ...
    for epoch in range(args.train_epochs):
        ...
        if args.model == 'BatLiNet':
            ...
            # vali_baseline_with_BLN does not track condition-level metrics yet.
            vali_condition_mape = float('nan')
            test_condition_mape = float('nan')
            vali_loss = vali_mape
        else:
