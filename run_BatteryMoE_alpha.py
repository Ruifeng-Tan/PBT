...
from models import BatteryMoE_DKPNorm, baseline_CPTransformerMoE, BatteryMoE_PESum_mask, BatteryMoE_DKPNorm_v2, baseline_CPMLPMoE
import wandb
...
for ii in range(args.itr):
    ...
    elif args.model == 'BatteryMoE_DKPNorm_v2':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_DKPNorm_v2.Model(model_config)
