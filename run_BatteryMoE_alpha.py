...
from models import BatteryMoE_horizontal_MHv2, baseline_CPTransformerMoE, BatteryMoE_diff_decom, BatteryMoE_Sparse_flexible, BatteryMoE_diff
import wandb
...
for ii in range(args.itr):
    ...
    elif args.model == 'BatteryMoE_diff_decom':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_diff_decom.Model(model_config)
