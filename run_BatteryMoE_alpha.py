...
from models import BatteryMoE_PCA_Transformer_ImpHyper, baseline_CPTransformerMoE, BatteryMoE_PCA_Transformer_Imp, BatteryMoE_PCA_Transformer, baseline_CPMLPMoE
import pickle
import wandb
...
for ii in range(args.itr):
    ...
    if args.model == 'baseline_CPTransformerMoE':
        ...
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_PCA_Transformer_ImpHyper.Model(model_config)
