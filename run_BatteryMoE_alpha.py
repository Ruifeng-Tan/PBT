...
from models import BatteryMoE_PCA_Transformer_casual, baseline_CPTransformerMoE, BatteryMoE_PCA_Transformer_EImp, BatteryMoE_PCA_Transformer, baseline_CPMLPMoE
import pickle
import wandb
...
for ii in range(args.itr):
    ...
    elif args.model == 'BatteryMoE_PCA_Transformer_EImp':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_PCA_Transformer_EImp.Model(model_config)
