...
from models import BatteryMoE_horizontal_MHv2_normv2, baseline_CPTransformerMoE, BatteryMoE_horizontal_MHv2, BatteryMoE_MHv2_PESum_Norm, baseline_CPMLPMoE
...
for ii in range(args.itr):
    ...
    elif args.model == 'BatteryMoE_horizontal_MHv2_normv2':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_horizontal_MHv2_normv2.Model(model_config)
