...
from models import BatteryMoE_Hyper_DualTrans, BatteryMoE_Hyper_CropAugIMPR, baseline_CPTransformerMoE, BatteryMoE_Hyper_CropAugIMP, baseline_CPMLPMoE
import pickle
import wandb
...
for ii in range(args.itr):
    ...
    elif args.model == 'BatteryMoE_Hyper_DualTrans':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_Hyper_DualTrans.Model(model_config)
    elif args.model == 'BatteryMoE_Hyper_CropAugIMPR':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_Hyper_CropAugIMPR.Model(model_config)
