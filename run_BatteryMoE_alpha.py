...
from models import BatteryMoE_MHv2_PESum_Norm_dp, baseline_CPTransformerMoE, BatteryMoE_MHv2_AllEfficient, BatteryMoE_MHv2_PESum_Norm, baseline_CPMLPMoE
...
for ii in range(args.itr):
    ...
    if args.model == 'baseline_CPTransformerMoE':
        ...
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_MHv2_PESum_Norm_dp.Model(model_config)
