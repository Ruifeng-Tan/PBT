...
from models import BatteryMoE_DKPNorm, baseline_CPTransformerMoE, BatteryMoE_PESum_mask, BatteryMoE_PESum_mask_norm, baseline_CPMLPMoE
import wandb
...
for ii in range(args.itr):
    ...
    elif args.model == 'BatteryMoE_PESum_mask_norm':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_PESum_mask_norm.Model(model_config)
