...
from models import BatteryMoE_allNorm_hardSelect, baseline_CPTransformerMoE, BatteryMoE_horizontal_MHv2, BatteryMoE_allNorm_hardSelect_base, baseline_CPMLPMoE
...
for ii in range(args.itr):
    ...
    elif args.model == 'BatteryMoE_allNorm_hardSelect':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = BatteryMoE_allNorm_hardSelect.Model(model_config)
