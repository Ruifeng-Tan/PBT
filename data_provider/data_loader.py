...
class Dataset_BatteryLifeLLM_original(Dataset):
    def __init__(self, args, flag='train', label_scaler=None, tokenizer=None, eval_cycle_max=None, eval_cycle_min=None, total_prompts=None, 
        ...
        if flag == 'train':
            ...
            self.cellName_prompt = pickle.load(open(f'{self.root_path}/training_DKP_embed_gptL.pkl', 'rb'))
        elif flag == 'val':
            self.files = [i for i in self.val_files]
            self.cellName_prompt = pickle.load(open(f'{self.root_path}/validation_DKP_embed_gptL.pkl', 'rb'))
        elif flag == 'test':
            self.files = [i for i in self.test_files]
            self.cellName_prompt = pickle.load(open(f'{self.root_path}/testing_DKP_embed_gptL.pkl', 'rb'))
