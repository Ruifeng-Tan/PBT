...
from models import PBT, PBT_M2, baseline_CPTransformerMoE, baseline_CPMLPMoE, CPTransformer_ablation
import pickle
import wandb
...
parser.add_argument('--llm_choice', type=str, required=False, default='Qwen3_8B', choices=['Llama', 'Qwen3_0.6B', 'Qwen3_8B'], help='The choice of the LLM embedding')
...
for ii in range(args.itr):
    ...
    setting = '{}_{}_{}_{}_bs{}_lr{}_dm{}_nh{}_el{}_dl{}_df{}_lradj{}_{}_guide{}_LB{}_loss{}_wd{}_wl{}_dr{}_gdff{}_E{}_GE{}_IE{}_HE{}_CE{}_K{}_S{}_aug{}_augW{}_tem{}_wDG{}_dsr{}_we{}_ffs{}_seed{}'.format(
        args.model,
        args.dk_factor,
        args.llm_choice,
        args.seq_len,
    ...
    elif args.model == 'PBT_M2':
        model_ec_config = BatteryElectrochemicalConfig(args.__dict__)
        model_text_config = AutoConfig.from_pretrained(args.LLM_path)
        model_config = BatteryLifeConfig(model_ec_config, model_text_config)
        model = PBT_M2.Model(model_config)
    ...
    if args.wd == 0:
        ...
        cl_model_optim = optim.Adam(trained_parameters, lr=args.learning_rate, weight_decay=args.wd)
    else:
