...
batch_size=8
finetune_method=AT
finetune_type=CPMLP2CPMLP # CPT2CPT
num_process=2
master_port=24978
...
CUDA_VISIBLE_DEVICES=4,5 accelerate launch  --multi_gpu --num_processes $num_process --main_process_port $master_port finetune_model.py \
  --args_path $args_path \
